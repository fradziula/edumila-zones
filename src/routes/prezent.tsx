...
// Pakiety prezentowe. UWAGA: do Stripe wysyłamy WYŁĄCZNIE `packageId`.
// Cena (`pricePln`) jest tu jedynie do wyświetlenia — backend mapuje
// `packageId` na właściwy Stripe Price ID i weryfikuje kwotę po swojej stronie.
...
function Prezent() {
  ...
  // Stan zgodny z późniejszą integracją Stripe.
  // Do backendu wysyłamy TYLKO `selectedPackageId`. Cena będzie weryfikowana po stronie serwera.
  const formState = {
    selectedPackageId,
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    // TODO(Stripe): wyślij { packageId: formState.selectedPackageId } do server function,
    // backend zmapuje packageId -> Stripe Price ID i utworzy Checkout Session.
  }
